...
internal sealed class CaptureTools
{
        ...
        string? state = null)
    {
        ...
        sessions = s switch
        {
            ...
            _ when s.Equals("all", StringComparison.OrdinalIgnoreCase) ||
                s.Length == 0 => sessions,
            _ => throw new NetcapMcpException(
        ...
        CancellationToken ct)
    {
        ...
        {
            throw new NetcapMcpException("durationSeconds must be > 0.");
        }
    ...
    private static StartCaptureRequest ValidateAndClampStart(StartCaptureRequest r)
    {
        ...
        {
            throw new NetcapMcpException("'source' is required.");
        }
